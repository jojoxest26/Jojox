...
const it: TranslationTree = {
  meta: {
    dateLocale: "it-IT",
    title: "JoJoX â€” Sicurezza per codice scritto dall'IA",
  },
  common: {
    severity: {
      critical: "Critico",
  ...
  hero: {
    ...
    body: "Non un controllo una tantum. {{monitoring}}. 21 controlli pubblici sugli errori piÃ¹ comuni nel codice scritto dall'IA, un {{score}} chiaro, e correzioni pronte da copiare.",
    ...
    pill3: "Gratis",
    badge: "Per progetti costruiti con Claude Code Â· Cursor Â· Lovable Â· Bolt",
    cta: "Analizza il tuo codice â€” gratis",
    guestNote: "1 analisi gratuita senza email. Poi basta la mail â€” 5 analisi/mese gratis.",
  },
  features: [
    {
      icon: "ðŸ›¡ï¸",
      ...
      text: "L'analisi che carichi a mano passa dai nostri server (per salvare punteggio e storico), ma il testo dei file non viene mai conservato â€” solo i risultati. Le correzioni automatiche, invece, restano sempre e solo nel tuo browser.",
    },
    {
      icon: "ðŸ”§",
      accent: "amber",
      title: "Non solo l'errore, anche come risolverlo",
      text: "Ogni problema Ã¨ accompagnato da un esempio di correzione, mostrato come un prima/dopo: capisci subito cosa cambiare.",
    },
    {
      icon: "ðŸ“Š",
      accent: "mint",
      title: "Punteggio di sicurezza + badge",
      text: "Un punteggio da 0 a 100, calcolato con una formula che vedi per intero, piÃ¹ un badge da mettere nel README del progetto.",
    },
  ],
  pricing: {
    ...
    noticeSuccess: "âœ“ Pagamento ricevuto, stiamo attivando il piano â€” qualche secondo e questa pagina si aggiorna da sola.",
    noticeCancel: "Attivazione annullata, nessun addebito. Riprova quando vuoi.",
    guestTitle: "ModalitÃ  ospite",
    guestList: [
    ...
    proList: [
      ...
      "Integrazione con GitHub: controlla ogni push e blocca le modifiche piÃ¹ rischiose",
    ...
    teamNote: "Per team con piÃ¹ repo",
    ...
    disclaimer: "Disdici quando vuoi, senza vincoli â€” l'abbonamento si gestisce da solo, direttamente dal tuo account.",
  },
  footer: {
    intro: "*Per l'analisi manuale:",
    items: [
      "Se salvi lo storico, inviamo solo un frammento minimo della riga interessata da ogni problema â€” mai la riga intera, mai il file.",
      "In modalitÃ  ospite, senza salvataggio, nulla lascia mai il tuo browser.",
      "L'integrazione GitHub, invece, elabora il codice sui nostri server.",
    ],
  },
  checksList: {
    title: "Tutti i controlli, senza segreti",
    body: "Il valore di JoJoX non sta nel nascondere come funziona, ma nel curare bene ogni controllo, testarlo e tenerlo aggiornato. Qui sotto trovi la lista completa: cosa controlliamo, quanto Ã¨ grave ogni problema, e quanto siamo sicuri di ogni segnalazione.",
    subLabel: "{{count}} controlli, in 4 livelli di gravitÃ ",
    note: "Â«ConfermatoÂ» = troviamo il problema per certo nel codice Â· Â«Da verificareÂ» = sembra mancare una protezione, ma potrebbe essere gestita altrove: controlla prima di preoccuparti.",
  },
  login: {
    sent: "Controlla la tua email: ti abbiamo mandato un link per accedere. Puoi chiudere questo popup.",
    prompt: "Accedi con la tua email â€” nessuna password, ti mandiamo un link.",
    sending: "Invioâ€¦",
  ...
  analyzer: {
    gateTitle: "Hai giÃ  usato la tua analisi gratuita senza email",
    ...
    dropzoneHintGuest: "ModalitÃ  ospite: 1 analisi gratuita, senza email. Dopo, basta la mail per continuare (5 al mese, gratis).",
    dropzoneHintAny: "Funziona su qualsiasi codice â€” anche scritto interamente a mano, non solo generato dall'AI.",
    moreFiles: "+{{count}} altri",
    analyzeButton: "Analizza",
    analyzeButtonCount: "Analizza {{count}} file",
    analyzing: "Analisi in corsoâ€¦",
    errorGuestUsed: "Risulta giÃ  usata l'analisi gratuita senza email (magari da un altro dispositivo sulla stessa rete). Accedi con la tua email per continuare â€” 5 analisi gratuite al mese.",
    errorGeneric: "Analisi fallita, riprova.",
    autofixFixedOne: "ðŸ”§ Ho corretto da solo {{files}} file per {{types}} tipo di problema.",
    autofixFixedMany: "ðŸ”§ Ho corretto da solo {{files}} file per {{types}} tipi di problema.",
    autofixManualSuffix: " Altri {{count}} restano da sistemare a mano â€” richiedono decisioni sul tuo progetto che non possiamo prendere al posto tuo.",
    autofixManualOnly: "I problemi trovati richiedono decisioni sul tuo progetto che non possiamo correggere in automatico â€” guarda gli esempi \"prima/dopo\" qui sotto.",
  ...
  findingsList: {
    ...
    emptyState: "Nessun problema trovato nei 21 controlli. ðŸŽ‰",
  },
  github: {
    title: "GitHub App + CI",
    badge: "DISPONIBILE",
    ...
    body2: "Basta impostarlo come controllo obbligatorio nelle impostazioni del branch: le modifiche rischiose non potranno piÃ¹ essere unite.",
    ...
    connectedLabel: "âœ“ COLLEGATO",
    toggleShow: "â–¼ Vedi anche: notifiche Slack, badge, CLI, VS Code e agenti AI",
    toggleHide: "â–² Nascondi dettagli avanzati",
    badgeTitle: "ðŸ·ï¸ Badge sempre aggiornato nel README",
    badgeBody: "Dopo aver collegato il repository, incolla questa riga nel tuo {{readme}} (sostituisci {{repo}} con i tuoi) â€” il punteggio si aggiorna da solo a ogni analisi, senza bisogno di rigenerarlo a mano:",
    terminalTitle: "ðŸ–¥ï¸ Anche da terminale, in VS Code e per agenti AI",
    terminalBody: "JoJoX si puÃ² usare anche senza sito: da riga di comando (con {{fix}} per correggere in automatico), come estensione VS Code che sottolinea i problemi mentre scrivi, o come strumento MCP per Claude Code e altri agenti AI, che cosÃ¬ possono controllarsi da soli mentre scrivono codice. Istruzioni complete nel {{link}}.",
    terminalLink: "README del repository",
    hookTitle: "ðŸª Blocco commit in locale",
    hookBody: "Un comando da terminale ({{cmd}}) installa un controllo che ferma il commit sul tuo computer, prima ancora che il codice arrivi su GitHub, se trova un problema critico â€” cosÃ¬ il problema non entra mai nella cronologia del repository.",
    slackTitle: "ðŸ”” Notifiche su Slack",
    ...
    slackSave: "Salva",
    slackSaved: "âœ“ Salvato",
    slackErrorGeneric: "Errore nel salvataggio",
  },
  waitlist: {
    title: "In arrivo",
    subtitle: "Ancora in lavorazione â€” te lo diciamo chiaramente, invece di fingere che esista giÃ :",
    roadmap: [
      {
        icon: "ðŸ‘¥",
        title: "Gestione team con piÃ¹ seat",
        text: "PiÃ¹ persone collegate a un solo abbonamento Team, con seat da aggiungere e dashboard condivisa â€” in arrivo a inizio settembre.",
      },
      {
        icon: "ðŸŒ",
        title: "Sito in piÃ¹ lingue",
        text: "JoJoX utilizzabile nella propria lingua madre, non solo in italiano.",
      },
      {
        icon: "âž•",
        title: "Correzioni che aggiungono codice mancante",
        text: "Oggi JoJoX corregge solo righe giÃ  presenti. In arrivo: la capacitÃ  di aggiungere da solo il codice che manca â€” una policy di sicurezza, un controllo assente â€” cosÃ¬ ogni analisi diventa un progetto giÃ  pronto all'uso, non solo un elenco di cose da sistemare a mano.",
      },
    ],
    emailPlaceholder: "tua@email.com",
    submit: "Unisciti alla lista d'attesa",
    done: "âœ“ Sei in lista!",
    error: "Qualcosa Ã¨ andato storto, riprova.",
  },
  supabase: {
    ...
    body2: "Non ti chiediamo mai le tue credenziali Supabase. Esegui tu stesso questa query di sola lettura (nessuna scrittura possibile) nell'{{sqlEditor}} del tuo progetto, copia il risultato in un file chiamato esattamente {{filename}}, e caricalo insieme al resto del codice nell'analyzer qui sopra â€” i risultati si aggiungono automaticamente a quelli degli altri 21 controlli.",
    sqlEditor: "SQL Editor",
    toggleShow: "â–¼ Mostra la query",
    toggleHide: "â–² Nascondi la query",
  },
  report: {
    brandSub: "Report di sicurezza del codice",
    reportLabel: "Report",
    generatedOn: "Generato il {{date}}",
    controlsNoLLM: "21 controlli Â· nessun LLM",
    ...
    manyProblems: "{{count}} problemi trovati, di gravitÃ  diversa",
    autofixNoteOne: "1 problema su {{total}} puÃ² essere corretto in automatico da JoJoX.",
    autofixNoteMany: "{{count}} problemi su {{total}} possono essere corretti in automatico da JoJoX.",
    autofixNoteSuffix: " Il file corretto Ã¨ scaricabile dal sito come archivio .zip, separatamente da questo report.",
...
const en: TranslationTree = {
  meta: {
    dateLocale: "en-GB",
    title: "JoJoX â€” Security for AI-written code",
  },
  common: {
    severity: {
      critical: "Critical",
  ...
  hero: {
    ...
    pill3: "Free",
    badge: "For projects built with Claude Code Â· Cursor Â· Lovable Â· Bolt",
    cta: "Analyze your code â€” free",
    guestNote: "1 free analysis with no email. Then just an email â€” 5 free analyses/month.",
  },
  features: [
    {
      icon: "ðŸ›¡ï¸",
      ...
      text: "The analysis you upload passes through our servers (to save the score and history), but the file contents are never kept â€” only the results. Automatic fixes, on the other hand, always stay in your browser.",
    },
    {
      icon: "ðŸ”§",
      accent: "amber",
  ...
  pricing: {
    ...
    noticeSuccess: "âœ“ Payment received, we're activating your plan â€” this page will refresh itself in a few seconds.",
    ...
    disclaimer: "Cancel anytime, no strings attached â€” the subscription manages itself, straight from your account.",
  },
  footer: {
    intro: "*For manual analysis:",
    items: [
      "If you save your history, we only send a minimal fragment of the line affected by each issue â€” never the whole line, never the file.",
  ...
  checksList: {
    ...
    note: "\"Confirmed\" = we find the problem for certain in the code Â· \"To verify\" = a protection seems to be missing, but it might be handled elsewhere: check before worrying.",
  },
  login: {
    sent: "Check your email: we've sent you a link to sign in. You can close this popup.",
    prompt: "Sign in with your email â€” no password, we'll send you a link.",
    sending: "Sendingâ€¦",
  ...
  analyzer: {
    ...
    dropzoneHintAny: "Works on any code â€” even written entirely by hand, not just AI-generated.",
    moreFiles: "+{{count}} more",
    analyzeButton: "Analyze",
    analyzeButtonCount: "Analyze {{count}} files",
    analyzing: "Analyzingâ€¦",
    errorGuestUsed: "The free analysis without email has already been used (maybe from another device on the same network). Sign in with your email to continue â€” 5 free analyses a month.",
    errorGeneric: "Analysis failed, try again.",
    autofixFixedOne: "ðŸ”§ I fixed {{files}} file myself for {{types}} type of issue.",
    autofixFixedMany: "ðŸ”§ I fixed {{files}} files myself for {{types}} types of issue.",
    autofixManualSuffix: " Another {{count}} still need fixing by hand â€” they need decisions about your project we can't make for you.",
    autofixManualOnly: "The issues found need decisions about your project we can't fix automatically â€” see the \"before/after\" examples below.",
  ...
  findingsList: {
    ...
    emptyState: "No problems found across the 21 checks. ðŸŽ‰",
  },
  github: {
    title: "GitHub App + CI",
    badge: "AVAILABLE",
    ...
    connectedLabel: "âœ“ CONNECTED",
    toggleShow: "â–¼ Also see: Slack notifications, badge, CLI, VS Code and AI agents",
    toggleHide: "â–² Hide advanced details",
    badgeTitle: "ðŸ·ï¸ Always up-to-date badge in the README",
    badgeBody: "After connecting the repository, paste this line into your {{readme}} (replace {{repo}} with yours) â€” the score updates itself on every analysis, no need to regenerate it by hand:",
    terminalTitle: "ðŸ–¥ï¸ Also from the terminal, in VS Code, and for AI agents",
    ...
    hookTitle: "ðŸª Local commit blocking",
    hookBody: "A terminal command ({{cmd}}) installs a check that stops the commit on your computer, before the code even reaches GitHub, if it finds a critical issue â€” so the problem never enters the repository's history.",
    slackTitle: "ðŸ”” Slack notifications",
  ...
  waitlist: {
    title: "Coming soon",
    subtitle: "Still in progress â€” we tell you clearly, instead of pretending it already exists:",
    roadmap: [
      {
        icon: "ðŸ‘¥",
        title: "Team management with more seats",
        text: "Multiple people connected to a single Team subscription, with seats to add and a shared dashboard â€” coming in early September.",
      },
      {
        icon: "ðŸŒ",
        title: "Site in more languages",
        text: "JoJoX usable in your own language, not just Italian.",
      },
      {
        icon: "âž•",
        title: "Fixes that add missing code",
        text: "Today JoJoX only fixes lines that already exist. Coming soon: the ability to add missing code on its own â€” a security policy, a missing check â€” so every analysis becomes a project that's already ready to use, not just a list of things to fix by hand.",
      },
    ],
    emailPlaceholder: "you@email.com",
    submit: "Join the waitlist",
    done: "âœ“ You're on the list!",
    error: "Something went wrong, try again.",
  },
  supabase: {
