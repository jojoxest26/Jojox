...
const it: TranslationTree = {
  ...
  fullSiteAudit: {
    ...
    ctaBuy: "Acquista il tuo Full Site Audit",
    buying: "Apertura del pagamento...",
    errorPurchase: "Errore nell'apertura del pagamento",
    creditsAvailable: "Hai {{count}} Full Site Audit disponibili — carica il tuo progetto quando vuoi.",
    ...
    analyzeButton: "Avvia il Full Site Audit",
    ...
    errorNoCredit: "Nessun Full Site Audit disponibile. Acquistane uno per continuare.",
